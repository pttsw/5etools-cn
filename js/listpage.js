...
class ListPage {
	...
	_renderStats_doBuildFluffTab_getHeaderControls ({ent, isImageTab = false}) {
		...
		const btnOptions = ee`<button class="ve-btn ve-btn-default ve-btn-xs stats__btn-stats-name" title="其他选项"><span class="glyphicon glyphicon-option-vertical"></span></button>`
