...
export class UnitConverter extends DmScreenPanelAppBase {
	...
	_$getPanelElement (board, state) {
		const units = [
			new _UnitConverterUnit("英寸", "2.54", "厘米", "0.394"),
			new _UnitConverterUnit("英尺", "0.305", "米", "3.28"),
			new _UnitConverterUnit("英里", "1.61", "公里", "0.620"),
			new _UnitConverterUnit("磅", "0.454", "千克", "2.20"),
			new _UnitConverterUnit("加仑", "3.79", "升", "0.264"),
			new _UnitConverterUnit("加仑", "8", "品脱", "0.125"),
		];
