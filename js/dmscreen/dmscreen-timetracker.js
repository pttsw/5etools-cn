...
class TimeTrackerRoot extends TimeTrackerBase {
	...
	render (eleParent) {
		...
		const btnShowClock = ee`<button class="ve-btn ve-btn-xs ve-btn-default mr-2" title="时钟"><span class="glyphicon glyphicon-time"></span></button>`
			.onn("click", () => this._state.tab = 0);
		const btnShowCalendar = ee`<button class="ve-btn ve-btn-xs ve-btn-default mr-3" title="日历"><span class="glyphicon glyphicon-calendar"></span></button>`
			.onn("click", () => this._state.tab = 1);
		const btnShowSettings = ee`<button class="ve-btn ve-btn-xs ve-btn-default mr-3" title="设置"><span class="glyphicon glyphicon-cog"></span></button>`
...
class TimeTrackerRoot_Clock extends TimeTrackerComponent {
	...
	render (eleParent, parent) {
		...
		const btnAddShortRest = ee`<button class="ve-btn ve-btn-xs ve-btn-default mr-2" title="添加一次短休时间 (按住SHIFT改为减去)">短休</button>`
