...
export class DmMapper extends DmScreenPanelAppBase {
	...
	static async pHandleMenuButtonClick (menu) {
		...
		eleModalInner.appends(`<div class="ve-flex-vh-center w-100 h-100"><i class="dnd-font ve-muted">加载中...</i></div>`);
...
class DmMapperRoot extends BaseComponent {
	...
	render (eleParent) {
		...
		eleParent.appends(`<div class="ve-flex-vh-center w-100 h-100"><i class="dnd-font ve-muted">加载中...</i></div>`);
