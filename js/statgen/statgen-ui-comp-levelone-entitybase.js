export class StatGenUiRenderLevelOneEntityBase {
	...
	render () {
		...
		const btnFilterForEntity = ee`<button class="ve-btn ve-btn-xs ve-btn-default br-0 pr-2" title="Filter for ${this._title}"><span class="glyphicon glyphicon-filter"></span> 筛选</button>`
			.onn("click", async () => {
		...
		const stgSel = ee`<div class="ve-flex-col mt-3">
			<div class="mb-1">选择一个${this._title}</div>
