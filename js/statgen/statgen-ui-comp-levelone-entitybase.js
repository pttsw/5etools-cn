export class StatGenUiRenderLevelOneEntityBase {
	...
	render () {
		...
		const btnFilterForEntity = ee`<button class="ve-btn ve-btn-xs ve-btn-default ve-br-0 ve-pr-2" title="Filter for ${this._title}"><span class="glyphicon glyphicon-filter"></span> 筛选</button>`
			.onn("click", async () => {
