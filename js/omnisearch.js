	...
	static _render_wrpSearchFilters ({rdState}) {
		...
		ee(rdState.wrpSearchFilters)`
			<div class="ve-flex-v-center ve-mr-2 ve-mobile-sm__mr-0 ve-mobile-sm__mb-2 ve-mobile-sm__w-100 ve-mobile-sm__flex-h-right">
				<span class="ve-mr-2 ve-italic ve-relative ve-top-1p">包含</span>
			...
			.map((result, ixInPage) => {
				...
				ee`<div class="omni__row-result ve-split-v-center stripe-odd">
					...
					<div class="ve-flex-v-center">
						${ptSource}
						${isSrd && category !== Parser.CAT_ID_PAGE ? `<span class="ve-muted omni__disp-srd ve-help-subtle ve-relative" title="可用于系统参考文档 (5.1)">[SRD]</span>` : ""}
						${isSrd52 && category !== Parser.CAT_ID_PAGE ? `<span class="ve-muted omni__disp-srd ve-help-subtle ve-relative" title="可用于系统参考文档 (5.2)">[SRD]</span>` : ""}
