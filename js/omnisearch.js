			...
			.map((result, ixInPage) => {
				...
				ee`<div class="omni__row-result split-v-center stripe-odd">
					...
					<div class="ve-flex-v-center">
						${ptSource}
						${isSrd && category !== Parser.CAT_ID_PAGE ? `<span class="ve-muted omni__disp-srd help-subtle relative" title="可用于系统参考文档 (5.1)">[SRD]</span>` : ""}
						${isSrd52 && category !== Parser.CAT_ID_PAGE ? `<span class="ve-muted omni__disp-srd help-subtle relative" title="可用于系统参考文档 (5.2)">[SRD]</span>` : ""}
