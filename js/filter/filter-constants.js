...
export const TITLE_BTN_RESET = "重置筛选器，按住Shift重置所有选项。";
...
export const MISC_FILTER_VALUE__BASIC_RULES_2014 = "基础规则(5e/2014)";
export const MISC_FILTER_VALUE__BASIC_RULES_2024 = "基础规则(5.5e/2024)";
