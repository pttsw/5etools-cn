...
export class LootGenGeneratorGemsArtObjects extends LootGenGeneratorBase {
	...
	async _goa_pDoHandleClickRollLoot () {
		...
		const lootOutput = new this._ClsLootGenOutput({
			...
			name: `${I18nUtil.get("page.lootgen.gems_art_objects")}: ${I18nUtil.get("page.lootgen.roughly")} ${this._state.gao_targetGoldAmount.toLocaleString()} ${LootGenUtils.getCoinageLabel("gp")}`,
			gems,
			artObjects,
		});
