...
class LootGenGeneratorFindTreasureBase extends LootGenGeneratorBase {
	...
	render ({tabMeta}) {
		...
		ee`<div class="ve-flex-col ve-py-2 ve-px-3">
			...
			<label class="ve-split-v-center ve-mb-2">
				<div class="ve-mr-2 ve-w-66 ve-no-shrink">${I18nUtil.get("page.lootgen.is_treasure_hoard")}</div>
				${cbIsHoard}
			</label>
...
export class LootGenGeneratorFindTreasure extends LootGenGeneratorFindTreasureBase {
	...
	_getHoardLootOutputType () {
		return `${I18nUtil.get("page.lootgen.treasure_hoard")}: ${this.constructor._CHALLENGE_RATING_RANGES[this._state.ft_challenge]}`;
	}
...
export class LootGenGeneratorFindTreasure24 extends LootGenGeneratorFindTreasureBase {
	...
	_getHoardLootOutputType () {
		return `${I18nUtil.get("page.lootgen.treasure_hoard")}: ${this.constructor._CHALLENGE_RATING_RANGES[this._state.ft_challenge]}, ${I18nUtil.get("page.lootgen.character_level")} ${this.constructor._CHARACTER_LEVEL_RANGES[this._state.ft_characterLevel].label}`;
	}
