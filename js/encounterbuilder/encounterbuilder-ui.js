...
export class EncounterBuilderUi extends BaseComponent {
	...
	_render_randomAndAdjust ({$parentRandomAndAdjust}) {
		...
		$$($parentRandomAndAdjust)`<div class="ve-flex-col">
			<div class="ve-flex-h-right mb-3">${Renderer.get().render(`{@note ${I18nUtil.get("enconterbuilder_rules_note")} {@book ${Parser.sourceJsonToFull(Parser.SRC_DMG)}|DMG|3|Creating a Combat Encounter}}`)}</div>
