...
export class EncounterBuilderUi extends BaseComponent {
	...
	_render_group ({rdState, stgGroup}) {
		stgGroup.appends(`<h4 class="ve-my-2">队伍信息</h4>`);
	...
	_renderGroupAndDifficulty_getGroupEles_advanced () {
		...
		const btnAddAdvancedCol = ee`<button class="ve-btn ve-btn-primary ve-btn-xxs ecgen-player__btn-inline ve-h-ipt-xs ve-bl-0 ve-bb-0 ve-bbl-0 ve-bbr-0 ve-btl-0 ve-ml-n1" title="新增列" tabindex="-1"><span class="glyphicon glyphicon-list-alt"></span></button>`
		...
		const stg = ee`<div class="ve-overflow-x-auto ve-flex-col">
			<div class="ve-flex-h-center ve-mb-2 ve-bb-1p ve-small-caps ve-self-flex-start">
				<div class="ve-w-100p ve-mr-1 ve-h-ipt-xs ve-no-shrink">名称</div>
				<div class="ve-w-40p ve-text-center ve-mr-1 ve-h-ipt-xs ve-no-shrink">等级</div>
				${wrpHeaders}
				${btnAddAdvancedCol}
			</div>
