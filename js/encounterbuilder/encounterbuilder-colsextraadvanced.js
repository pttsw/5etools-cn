export class EncounterBuilderRenderableCollectionColsExtraAdvanced extends RenderableCollectionBase {
	...
	getNewRender (colExtra, i) {
		...
		const btnDelete = veT`<button class="ve-btn ve-btn-xxs ecgen-player__btn-inline ve-w-40p ve-btn-danger ve-no-shrink ve-mt-n2 ve-bt-0 ve-btl-0 ve-btr-0" title="删除列" tabindex="-1"><span class="glyphicon-trash glyphicon"></span></button>`
