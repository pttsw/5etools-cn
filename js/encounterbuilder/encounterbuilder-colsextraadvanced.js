export class EncounterBuilderRenderableCollectionColsExtraAdvanced extends RenderableCollectionBase {
	...
	getNewRender (colExtra, i) {
		...
		const btnDelete = ee`<button class="ve-btn ve-btn-xxs ecgen-player__btn-inline w-40p ve-btn-danger no-shrink mt-n2 bt-0 btl-0 btr-0" title="删除列" tabindex="-1"><span class="glyphicon-trash glyphicon"></span></button>`
