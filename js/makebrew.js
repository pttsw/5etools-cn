...
class PageUi extends ProxyBase {
	...
	_initHeader_mode ({wrpSettingsTop}) {
		this._selBuilderMode = veT`<select class="ve-form-control ve-input-xs">
			...
			<option value="none" class="ve-italic">其他</option>
		</select>`
		...
		veT`<div class="ve-flex-v-center ve-mr-2 ve-mobile-md__mr-0 ve-mobile-md__mb-2">
			<div class="ve-mr-2 ve-bold">模式</div>
	...
	_initHeader_existing ({wrpSettingsBtm}) {
		const btnEditExisting = veT`<button class="ve-btn ve-btn-xs ve-btn-default" title="Hotkey: o">编辑已存在内容</button>`
